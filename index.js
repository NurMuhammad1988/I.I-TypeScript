...
const nur = new Persons("Nur-1", 23);
console.log(nur);
console.log(nur.seyHello()); //Persons ona classni seyHello metodi
/////////////
class Student extends Persons {
    constructor(name, age, group, courses) {
        super(name, age);
...
const sardor = new Student("Nur-2", 35, "34-gruhi", 4);
console.log(sardor);
console.log(sardor.seyHello()); //Student classni seyHello metodi
const newSardor = sardor; //newSardor o'zgaruvchi yani hech narsasi yo'q yangi o'zgaruvchi Personsdan vorislanib  qiymatlarini sardorga berdi endi newSardorda eski sardor o'zgaruvchi bor
console.log(newSardor);
...
const abror = new Teacher("Abror", 34, ["React.js", "JS", "Next.js"]);
console.log(abror);
